...
return [
  'ctrl' => [
    'title' => 'LLL:EXT:nano/Resources/Private/Language/locallang_nano.xlf:tx_nano_domain_model_vmodel.label',
    'label' => 'title',
    'label_alt' => 'bodytext',
    'tstamp' => 'tstamp',
    'crdate' => 'crdate',
  ...
  'columns' => [
    ...
    'vbrand' => [
      'exclude' => 0,
      'label' => 'LLL:EXT:nano/Resources/Private/Language/locallang_nano.xlf:tx_nano_domain_model_vbrand.label',
      'config' => [
        'type' => 'select',
        'renderType' => 'selectSingle',
        'foreign_table' => 'tx_nano_domain_model_vbrand',
        'foreign_table_where' => 'ORDER BY tx_nano_domain_model_vbrand.sorting',
        'size' => '6',
        'minitems' => '1',
        'maxitems' => '1',
      ]
